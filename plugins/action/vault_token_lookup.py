...
# @hand-crafted
# Endpoint changed to lookup-self; schema set to None (token param collision).
...
class ActionModule(VaultActionBase):
    """Look up information about a Vault token."""

    OPERATION = Operation("POST", "v1/auth/token/lookup-self", None)

...
DOCUMENTATION = """
---
module: vault_pki_role_info
short_description: Read or list Vault PKI roles
description:
  - Read or list Vault PKI roles using the Vault HTTP API.
version_added: "2.0.0"
author:
...
options:
    name:
      description: Name of the PKI role. Omit to list all.
      type: str
    mount_path:
...
- name: Read or list Vault PKI roles
  hashicorp.vault.vault_pki_role_info:
    url: "{{ vault_addr }}"
    token: "{{ vault_token }}"

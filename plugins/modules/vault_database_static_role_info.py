...
DOCUMENTATION = """
---
module: vault_database_static_role_info
short_description: Read or list Vault database static roles
description:
  - Read or list Vault database static roles using the Vault HTTP API.
version_added: "2.0.0"
author:
...
options:
    name:
      description: Name of the static role. Omit to list all.
      type: str
    mount_path:
...
- name: Read or list Vault database static roles
  hashicorp.vault.vault_database_static_role_info:
    url: "{{ vault_addr }}"
    token: "{{ vault_token }}"

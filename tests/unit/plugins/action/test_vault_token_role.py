...
def action_module():
    ...
    from ansible_collections.hashicorp.vault.plugins.action.vault_token_role import ActionModule

    task = MagicMock()
    task.action = "hashicorp.vault.vault_token_role"
    task.args = {
...
class TestActionModule:
    """Tests for vault_token_role action plugin."""

...
def action_module():
    ...
    from ansible_collections.hashicorp.vault.plugins.action.vault_database_role import ActionModule

    task = MagicMock()
    task.action = "hashicorp.vault.vault_database_role"
    task.args = {
...
class TestActionModule:
    """Tests for vault_database_role action plugin."""

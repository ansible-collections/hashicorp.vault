...
def action_module():
    ...
    from ansible_collections.hashicorp.vault.plugins.action.vault_pki_role import ActionModule

    task = MagicMock()
    task.action = "hashicorp.vault.vault_pki_role"
    task.args = {
...
class TestActionModule:
    """Tests for vault_pki_role action plugin."""
